-- Transacción de Publicación de Directorio
-- Esta función asegura que una revisión pase a 'published' y se vuelquen todos sus datos de JSON a Tablas
-- de forma atómica. Si hay un error de estructura de datos, no se inserta nada.
